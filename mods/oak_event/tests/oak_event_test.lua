...
for _, mp in ipairs({ "OAKS_LAB", "PALLET_TOWN", "BILLS_HOUSE",
                      "CINNABAR_LAB_METRONOME_ROOM", "INDIGO_PLATEAU", "ROUTE_1" }) do
...
T.check(MS.baseTalk("BILLS_HOUSE", "TEXT_BILLSHOUSE_BILL_SS_TICKET") ~= nil,
  "vanilla Bill S.S. TICKET handler still behind the override")
