...
English lives next door, in `es_es-worksheet/`, one tab-separated file per
catalog:
...
```sh
python3 tools/modkit.py validate es_es --base imported
python3 tools/modkit.py translation es_es --refresh   # pick up new engine strings
