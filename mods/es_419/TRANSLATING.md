# Translating into Español (Latinoamérica)
...
English lives next door, in `es_419-worksheet/`, one tab-separated file per
catalog:
...
```sh
python3 tools/modkit.py validate es_419 --base imported
python3 tools/modkit.py translation es_419 --refresh   # pick up new engine strings
